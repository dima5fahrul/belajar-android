package com.example.belajarandroid.local_data_persistent.setting_shared_preferences
...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    private lateinit var loveMu: String
    ...
    private fun setSummaries() {
        ...
        isLoveMuPreference.isChecked = sh?.getBoolean(loveMu, false) ?: false
    }
    ...
    private fun init() {
        ...
        loveMu = resources.getString(R.string.key_love)
        ...
        isLoveMuPreference = findPreference<CheckBoxPreference>(loveMu) as CheckBoxPreference
    }
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        ...
        if (key == loveMu) {
            isLoveMuPreference.isChecked = sharedPreferences?.getBoolean(loveMu, false) ?: false
        }
    }
}